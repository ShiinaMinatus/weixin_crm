...
<body style="overflow-x: hidden;">
    <div style="position: relative;left: 10px; top: 10px;"><a href="{$WebSiteUrl}/pageredirst.php?action=web&functionname=stylistIntroduction"><button class="btn btn-primary">返回</button></a></div>
    ...
    <div style="margin-left:15px;margin-top:15px;">
        <div style="width: 300px; margin: 0 auto;">
            ...
            <form class="form-horizontal" action="{$WebSiteUrl}/pageredirst.php?action=web&functionname=stylistUpdate&ItemId={$stylistValue.stylist_id}" enctype="multipart/form-data" method="Post">
                <input name='exchange_type' value="1" type="hidden">
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">姓名：</label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control inputWidth" value="{$stylistValue.stylist_name}" name="stylist_name" id="exchangeName">
                    </div>
                </div>
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">介绍：</label>
                    <div class="col-sm-2">
                        <textarea  class="form-control inputWidth" rows="3" name="stylist_info" id="stylist_info">{$stylistValue.stylist_info}</textarea>
                    </div>
                </div>
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">特长：</label>
                    <div class="col-sm-2">
                        <textarea  class="form-control inputWidth" rows="3" name="specialty" id="specialty">{$stylistValue.specialty}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                        ...
                        <param name="flashvars" value="imgUrl={$WebSiteUrl}/images/inhouse/{$stylistValue.stylist_image}&uploadUrl={$WebSiteUrl}/photoCut/upfile1.php&uploadSrc=false" />
                        <EMBED src="{$WebSiteUrl}/photoCut/avatar.swf" quality=high bgcolor=#FFFFFF WIDTH="650" HEIGHT="450" wmode="transparent" flashVars="imgUrl={$WebSiteUrl}/images/inhouse/{$stylistValue.stylist_image}&uploadUrl={$WebSiteUrl}/photoCut/upfile1.php&uploadSrc=false"
    ...
    <input type="hidden" id="photoUrl" value="{$WebSiteUrl}/images/inhouse/">
</body>
