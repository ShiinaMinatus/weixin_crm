...
<html>
    ...
    <div style="margin-left:15px;margin-top:15px;">
        <div style="width: 300px; margin: 0 auto;">
            ...
            <form class="form-horizontal" action="{$WebSiteUrl}/pageredirst.php?action=web&functionname=addstylist" enctype="multipart/form-data" method="Post">
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control inputWidth" value="" name="stylist_name" id="exchangeName">
                    </div>
                </div>
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">介绍：</label>
                    <div class="col-sm-2">
                        <textarea  class="form-control inputWidth" rows="3" name="stylist_info" id="stylist_info"></textarea>
                    </div>
                </div>
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">特长：</label>
                    <div class="col-sm-2">
                        <textarea  class="form-control inputWidth" rows="3" name="specialty" id="specialty"></textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <OBJECT classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
                        ...
                        <param name="flashvars" value="imgUrl={$WebSiteUrl}/photoCut/default.jpg&uploadUrl={$WebSiteUrl}/photoCut/upfile1.php&uploadSrc=false" />
                        <EMBED src="{$WebSiteUrl}/photoCut/avatar.swf" quality=high bgcolor=#FFFFFF WIDTH="650" HEIGHT="450" wmode="transparent" flashVars="imgUrl={$WebSiteUrl}/photoCut/default.jpg&uploadUrl={$WebSiteUrl}/photoCut/upfile1.php&uploadSrc=false"
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content" >
                            ...
                            <div class="modal-footer">
                                ...
                                <input type="hidden" id="deleteUrl" value="{$WebSiteUrl}/pageredirst.php?action=web&functionname=addstylist"  />
                            </div>
                        </div><!-- /.modal-content -->
                    </div><!-- /.modal-dialog -->
                </div><!-- /.modal -->
...
$("#checkButton").attr("href", deleteUrl);                
