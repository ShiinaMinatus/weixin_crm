<?php /* Smarty version Smarty-3.0-RC2, created on 2014-06-04 14:39:08
         compiled from "/web/www/weixin_crm//templates/inhouse/left.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1586109222538ebf0ceee358-86227424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e9a0ec88f1d898ac6ff82492216e4e3a80ead9bc' => 
    array (
      0 => '/web/www/weixin_crm//templates/inhouse/left.tpl',
      1 => 1401863711,
    ),
  ),
  'nocache_hash' => '1586109222538ebf0ceee358-86227424',
  'function' => 
  array (
  ),
...
/pageredirst.php?action=admin&functionname=setAccount" target="mainFrame" class="left-fontSmall" >重置账户密码</a>
                                    ...
                                    <?php }?>
                                     ...
                                     <?php if ($_smarty_tpl->getVariable('auth_result')->value[42]==1){?>
                                        <tr>
                                            ...
                                            <td width="85%">
                                                ...
                                                <div class='left-a' >
                                                    ...
                                                    <a  style='color: #3394c4' href="<?php echo $_smarty_tpl->getVariable('WebSiteUrl')->value;?>
/pageredirst.php?action=web&functionname=stylistIntroduction" target="mainFrame" class="left-fontSmall" >发型师列表</a>
                                    ...
                                    <?php }?>
                                       <?php if ($_smarty_tpl->getVariable('auth_result')->value[43]==1){?>
                                        <tr>
                                            ...
                                            <td width="85%">
                                                ...
                                                <div class='left-a' >
                                                    ...
                                                    <a  style='color: #3394c4' href="<?php echo $_smarty_tpl->getVariable('WebSiteUrl')->value;?>
/pageredirst.php?action=web&functionname=addstylist" target="mainFrame" class="left-fontSmall" >添加发型师</a>
