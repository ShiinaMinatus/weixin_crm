<?php /* Smarty version Smarty-3.0-RC2, created on 2014-05-27 10:28:57
         compiled from "C:/Apache24/htdocs/yajie_weixin_crm/weixin_crm//templates/jiantang/exchange/exchangeEdit.tpl" */ ?>
<?php /*%%SmartyHeaderCode:65845383f8690f1337-26132856%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fef2d57f432c9e11e9dd832b112490a12280378c' => 
    array (
      0 => 'C:/Apache24/htdocs/yajie_weixin_crm/weixin_crm//templates/jiantang/exchange/exchangeEdit.tpl',
      1 => 1401075146,
    ),
  ),
  'nocache_hash' => '65845383f8690f1337-26132856',
  'function' => 
  array (
  ),
...
/pageredirst.php?action=exchange&functionname=ExchangeList"><button class="btn btn-primary">返回</button></a></div>
...
/pageredirst.php?action=exchange&functionname=exchangeUpdate&ItemId=<?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_id'];?>
" enctype="multipart/form-data" method="Post">
                <div class="form-group"> 
                    <label for="inputEmail3" class="col-sm-2 control-label labelWidth">礼品名称：</label>
                    <div class="col-sm-2">
                        <input class="form-control inputWidth" type="text" value="<?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_name'];?>
" name="exchange_name" id="exchangeName">
                    </div>
                </div> 
                <div class="form-group"> 
                    ...
                    <div class="col-sm-2">
                        <select name="exchange_type" id='exchangeType' class="form-control inputWidth">
                            <?php if ($_smarty_tpl->getVariable('exchageValue')->value['exchange_type']==0){?>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control inputWidth" value="<?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_integration'];?>
" name="exchange_integration" id="exchangeIntegration">
                    </div>
                </div>
                ...
                <div class="form-group"> 
                    ...
                    <div class="col-sm-2">
<!--                        <input type="text" class="form-control inputWidth" value="<?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_summary'];?>
" name="exchange_summary" id="exchangeSummary">-->
                        <textarea  class="form-control inputWidth" rows="3" name="exchange_summary" id="exchangeSummary"><?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_summary'];?>
</textarea>
                    </div>
...
/giftImages/<?php echo $_smarty_tpl->getVariable('exchageValue')->value['exchange_image'];?>
