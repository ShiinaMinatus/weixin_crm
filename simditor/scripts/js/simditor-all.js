...
(function() {
    ...
    HrButton = (function(_super) {
        ...
        HrButton.prototype.htmlTag = 'font,color';

        HrButton.prototype.meun = true;
...
(function() {
    ...
    HrButton = (function(_super) {
        ...
        function HrButton() {
            ...
            //$.merge(this.editor.formatter._allowedAttributes['font'], ['color']);
        ...
        HrButton.prototype.disableTag = 'color';

        HrButton.prototype.menu = true;

        HrButton.prototype.status = function($node) {
            return true;
        };

        // HrButton.prototype.command = function(param) {
        ...
        HrButton.prototype.renderMenu = function() {
            var _this = this;
            $('<div class="dasd"></div>').appendTo(this.menuWrapper);
            this.createMenu = this.menuWrapper.find('.dasd');
            this.editMenu = this.menuWrapper.find('.menu-edit-color');

            var colorArray = ['red', 'yellow', 'blue', 'black', 'orange', 'gray'];

            var divColor = '<div style="margin-left:4px;margin-top:4px;">';

            for (var i = 0; i < colorArray.length; i++) {

                divColor += '<div class="color-div" id="' + colorArray[i] + '" style="height: 20px; width:20px;padding: 0;border: 2px solid #ffffff;cursor: pointer;background-color:' + colorArray[i] + ';float:left; ;">&nbsp;</div>';

            }

            divColor += '</div>'

            $(divColor).appendTo(this.createMenu);
            //this.createTable(6, 6).appendTo(this.createMenu);


            return this.createMenu.on('mousedown', '.color-div', function(e) {
