        ...
        $('#' + packageArrayList[i])[0].ondragstart = function(ev) {
            ...
            switch (eleT) {
                ...
                case 'text':
                    ...
                    var textAreaHtml = '<div class="textArea"  style="width:320px; margin:0 auto;"   belog="' + eleType + '" ><div style="float:left; text-align:center" contenteditable="true"><p style="outline: none;" class="textArea" belog="' + eleType + '" >本可视化布局程序在HTML5浏览器上运行更加完美, 能实现自动本地化保存, 即使关闭了网页, 下一次打开仍然能恢复上一次的操作.</p></div>' + closeHtml + '</div>';
